...
താങ്കളുടെ അഭിപ്രായം ഞങ്ങളുടെ ഉപയോഗനിബന്ധനകൾക്ക് വിധേയമായിരിക്കും.',
	...
	'mobile-frontend-donate-image-login' => 'താങ്കൾ അപ്‌ലോഡ് ചെയ്തവ കാണാൻ പ്രവേശിക്കുക',
...
捐贈您的照片，使這些頁更精彩。亦讓{{SITENAME}}編輯社群使用您的照片。',
	...
	'mobile-frontend-photo-license' => '點擊「提交」表示您同意[//wikimediafoundation.org/wiki/Terms_of_use 使用條款]，並同意依據[//en.wikipedia.org/wiki/Wikipedia:Text_of_Creative_Commons_Attribution-ShareAlike_3.0_Unported_License CC BY-SA 3.0協議]授權您的照片。',
	'mobile-frontend-photo-submit' => '提交',
	'mobile-frontend-photo-cancel' => '取消',
