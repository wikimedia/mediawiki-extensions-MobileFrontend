...
$messages['ar'] = array(
	...
	'mobile-frontend-main-menu-upload' => 'رفع',
	...
	'mobile-frontend-photo-upload' => 'أضف أول صورة لهذه الصفحة', # Fuzzy
	...
	'mobile-frontend-photo-caption-placeholder' => 'أضف تعليق على صورتك', # Fuzzy
	'mobile-frontend-image-loading' => 'يجري تحميل الصورة',
	'mobile-frontend-image-uploading' => 'يجري رفع الصورة', # Fuzzy
	'mobile-frontend-photo-upload-error' => 'حدث خطأ ما أثناء رفع الصورة. من فضلك حاول رفع صورة أخرى.', # Fuzzy
...
$messages['ast'] = array(
	...
	'mobile-frontend-photo-upload' => 'Amestar la primera foto a esta páxina', # Fuzzy
	...
	'mobile-frontend-photo-caption-placeholder' => 'Amestar un pie pa esta imaxe', # Fuzzy
	'mobile-frontend-image-loading' => 'Cargando la imaxe',
	'mobile-frontend-image-uploading' => 'Xubiendo la imaxe', # Fuzzy
	'mobile-frontend-photo-upload-error' => 'Hebo un error al xubir la imaxe. Por favor, prueba con otra imaxe.', # Fuzzy
	'mobile-frontend-photo-license' => "Nota: Toles fotos qu'espublices tarán baxo una [//en.wikipedia.org/wiki/Wikipedia:Text_of_Creative_Commons_Attribution-ShareAlike_3.0_Unported_License llicencia CC BY-SA 3.0]", # Fuzzy
...
$messages['be-tarask'] = array(
	...
	'mobile-frontend-main-menu-upload' => 'Запампоўка',
	...
	'mobile-frontend-image-uploading' => 'Запампоўка выявы', # Fuzzy
...
$messages['cy'] = array(
	...
	'mobile-frontend-image-uploading' => 'Uwchlwytho delwedd', # Fuzzy
...
$messages['de'] = array(
	...
	'mobile-frontend-donate-image-login' => 'Melde dich an, um deine hochgeladenen Dateien anzusehen',
...
Hilf mit, Leben in diese Seiten zu bringen, indem du Bilder spendest, die von der großen {{SITENAME}}-Gemeinschaft verwendet werden können.',
	...
	'mobile-frontend-photo-upload' => 'Das erste Foto zur Seite hinzufügen', # Fuzzy
	...
	'mobile-frontend-photo-caption-placeholder' => 'Füge eine Beschreibung für dieses Bild hinzu', # Fuzzy
	'mobile-frontend-image-loading' => 'Lade Bild',
	'mobile-frontend-image-uploading' => 'Lade Bild hoch', # Fuzzy
	'mobile-frontend-photo-upload-error' => 'Beim Hochladen des Bildes ist ein Fehler aufgetreten. Bitte versuche ein anderes Bild.', # Fuzzy
	'mobile-frontend-photo-license' => 'Hinweis: Alle Fotos werden unter einer [//de.wikipedia.org/wiki/Wikipedia:Lizenzbestimmungen_Commons_Attribution-ShareAlike_3.0_Unported CC-BY-SA-3.0-Lizenz] veröffentlicht.', # Fuzzy
...
İrtıbat',
	...
	'mobile-frontend-image-uploading' => 'Resım bar beno', # Fuzzy
...
$messages['fr'] = array(
	...
	'mobile-frontend-donate-image-login' => 'Connectez-vous pour voir vos importations',
...
Il y a beaucoup de pages qui n'ont pas de photo à cause d'un manque important de photos libres de droits. Aidez à faire vivre ces pages en donnant vos photos dont vous voulez vous débarrasser et qui pourraient être en aide à la large communauté des éditeurs de {{SITENAME}}.",
	...
	'mobile-frontend-photo-upload' => 'Ajouter la première photo à cette page', # Fuzzy
	...
	'mobile-frontend-photo-caption-placeholder' => 'Ajouter une légende pour cette image', # Fuzzy
	'mobile-frontend-image-loading' => "Chargement de l'image",
	'mobile-frontend-image-uploading' => "Téléchargement de l'image", # Fuzzy
	'mobile-frontend-photo-upload-error' => "Une erreur s'est produite pendant le téléchargement de l'image. Veuillez essayer une autre image.", # Fuzzy
	'mobile-frontend-photo-license' => 'Remarque: Toutes les photos que vous publiez le seront sous une [//en.wikipedia.org/wiki/Wikipedia:Text_of_Creative_Commons_Attribution-ShareAlike_3.0_Unported_License licence CC BY-SA 3.0]', # Fuzzy
...
$messages['gl'] = array(
	...
	'mobile-frontend-donate-image-login' => 'Acceda ao sistema para ollar as súas cargas',
...
Axude a darlles vida a estas páxinas achegando aquelas imaxes que poidan ser de utilidade para a gran comunidade de editores de {{SITENAME}}.',
	...
	'mobile-frontend-photo-upload' => 'Engadir a primeira fotografía a esta páxina', # Fuzzy
	...
	'mobile-frontend-photo-caption-placeholder' => 'Engadir un pé de foto para esta imaxe', # Fuzzy
	'mobile-frontend-image-loading' => 'Cargando a imaxe',
	'mobile-frontend-image-uploading' => 'Subindo a imaxe', # Fuzzy
	'mobile-frontend-photo-upload-error' => 'Houbo un erro ao cargar a imaxe. Inténteo con outra imaxe.', # Fuzzy
	'mobile-frontend-photo-license' => 'Nota: Todas as fotografías que publique quedarán baixo a [//gl.wikipedia.org/wiki/Wikipedia:Texto_da_Licenza_Creative_Commons_Recoñecemento-CompartirIgual_3.0 licenza CC BY-SA 3.0]', # Fuzzy
...
$messages['it'] = array(
	...
	'mobile-frontend-photo-upload' => 'Aggiungi la prima foto a questa pagina', # Fuzzy
	...
	'mobile-frontend-photo-caption-placeholder' => "Aggiungi una didascalia all'immagine", # Fuzzy
	'mobile-frontend-image-loading' => 'Caricamento immagine',
	'mobile-frontend-image-uploading' => 'Caricamento immagine', # Fuzzy
	'mobile-frontend-photo-upload-error' => "Si verificato un errore durante il caricamento dell'immagine. Si prega di riprovare con un'altra immagine.", # Fuzzy
...
$messages['ja'] = array(
	...
	'mobile-frontend-donate-image-login' => '自分のアップロード一覧を閲覧するにはログインしてください',
	...
	'mobile-frontend-image-uploading' => '画像をアップロード中', # Fuzzy
	'mobile-frontend-photo-upload-error' => '画像をアップロードする際にエラーが発生しました。別の画像を試してください。', # Fuzzy
...
$messages['ko'] = array(
	...
	'mobile-frontend-donate-image-login' => '내 올리기를 보려면 로그인하세요',
...
나눠주고자 하는 그림을 기부하면 이 문서에 생명을 가져다주는 데 도음이 되고 넓은 {{SITENAME}} 편집 공동체에 사용할 수 있습니다.',
	...
	'mobile-frontend-photo-caption-placeholder' => '이 그림에 설명 추가', # Fuzzy
	'mobile-frontend-image-loading' => '그림을 불러오는 중',
	'mobile-frontend-image-uploading' => '그림을 올리는 중', # Fuzzy
	'mobile-frontend-photo-upload-error' => '그림을 올리는 동안 오류가 발생했습니다. 다른 그림을 올리세요.', # Fuzzy
	'mobile-frontend-photo-license' => '참고: 게시하는 모든 그림은 [//ko.wikipedia.org/wiki/%EC%9C%84%ED%82%A4%EB%B0%B1%EA%B3%BC:Creative_Commons_Attribution-ShareAlike_3.0_Unported_License CC BY-SA 3.0 라이선스]로 배포됩니다', # Fuzzy
...
Помогнете ни да ги оживееме страниците - дарувајте ваши слики што би биле од полза за поширокото уредништво на {{SITENAME}}.',
	...
	'mobile-frontend-photo-upload' => 'Стави ја првата слика во страницава', # Fuzzy
	...
	'mobile-frontend-photo-caption-placeholder' => 'Ставете опис на сликата', # Fuzzy
	'mobile-frontend-image-loading' => 'Ја вчитувам сликата...',
	'mobile-frontend-image-uploading' => 'Ја подигам сликата', # Fuzzy
	'mobile-frontend-photo-upload-error' => 'Се појави грешка при подигањето на сликата. Обидете се со друга слика.', # Fuzzy
	'mobile-frontend-photo-license' => 'Напомена: Сите слики што ги подигате ќе бидат објавени под лиценцата [//en.wikipedia.org/wiki/Wikipedia:Text_of_Creative_Commons_Attribution-ShareAlike_3.0_Unported_License BY-SA 3.0]', # Fuzzy
...
ഈ താളുകൾക്കായി താങ്കൾക്ക് ചിത്രങ്ങൾ സംഭാവന ചെയ്യാവുന്നതാണ്, അവ വിശാലമായ {{SITENAME}} തിരുത്തൽ സമൂഹം ഫലപ്രദമായി ഉപയോഗിച്ചുകൊള്ളും.',
	...
	'mobile-frontend-photo-upload' => 'ഈ താളിലേയ്ക്ക് ആദ്യ ചിത്രം ചേർക്കുക', # Fuzzy
	...
	'mobile-frontend-photo-caption-placeholder' => 'ഈ ചിത്രത്തിന് ഒരു അടിക്കുറിപ്പ് ചേർക്കുക', # Fuzzy
	'mobile-frontend-image-loading' => 'ചിത്രം എടുക്കുന്നു',
	'mobile-frontend-image-uploading' => 'ചിത്രം അപ്‌ലോഡ് ചെയ്യുന്നു', # Fuzzy
	'mobile-frontend-photo-upload-error' => 'ചിത്രം അപ്‌ലോഡ് ചെയ്തുകൊണ്ടിരിക്കെ ഒരു പിഴവുണ്ടായി. ദയവായി മറ്റൊരു ചിത്രം പരീക്ഷിക്കുക.', # Fuzzy
	'mobile-frontend-photo-license' => 'കുറിപ്പ്: താങ്കൾ പ്രസിദ്ധീകരിക്കുന്ന എല്ലാ ചിത്രങ്ങളും [//en.wikipedia.org/wiki/Wikipedia:Text_of_Creative_Commons_Attribution-ShareAlike_3.0_Unported_License സി.സി. ബൈ എസ്.എ. 3.0 അനുവാദപത്രം] പ്രകാരമാകും പ്രസിദ്ധീകരിക്കുക', # Fuzzy
...
$messages['ro'] = array(
	...
	'mobile-frontend-donate-image-login' => 'Autentificați-vă pentru a vă vizualiza încărcările',
...
Ajutați-ne să dăm viață acestor pagini, donând acele fotografii pe care doriți să le dați mai departe și care ar putea fi în folosul editorial al comunității de la {{SITENAME}}.',
	...
	'mobile-frontend-photo-upload' => 'Adaugă prima fotografie pentru această pagină', # Fuzzy
	...
	'mobile-frontend-photo-caption-placeholder' => 'Adăugați o descriere pentru această imagine', # Fuzzy
	'mobile-frontend-image-loading' => 'Se încarcă afișarea imaginii',
	'mobile-frontend-image-uploading' => 'Se încarcă imaginea', # Fuzzy
	'mobile-frontend-photo-upload-error' => 'A apărut o eroare în timpul încărcării acestei imagini. Încercați altă imagine.', # Fuzzy
	'mobile-frontend-photo-license' => 'Notă: Toate fotografiile pe care le publicați vor fi eliberate sub o licență [//en.wikipedia.org/wiki/Wikipedia:Text_of_Creative_Commons_Attribution-ShareAlike_3.0_Unported_License CC BY-SA 3.0]', # Fuzzy
...
$messages['roa-tara'] = array(
	...
	'mobile-frontend-main-menu-upload' => 'Careche',
...
Jutane a portar ste pàjine a ła vita donandoghe łe to someje, podaria anca esar utiłe pa' ła pì granda comunità de editing de {{SITENAME}}.",
	...
	'mobile-frontend-photo-upload' => 'Xonta ła prima someja a sta pàjina', # Fuzzy
	...
	'mobile-frontend-photo-caption-placeholder' => "Xonta na didascałia a l'imaxene", # Fuzzy
	'mobile-frontend-image-loading' => 'Cargamento imaxene',
	'mobile-frontend-image-uploading' => 'Cargamento imaxene', # Fuzzy
	'mobile-frontend-photo-upload-error' => "S'a verifegà un eror durante el cargamento de l'imaxene. Se prega de ripróvar có n'altra imaxene.", # Fuzzy
	'mobile-frontend-photo-license' => 'Nota: tute łe someje publicae łe sarà rełasae có [//en.wikipedia.org/wiki/Wikipedia:Text_of_Creative_Commons_Attribution-ShareAlike_3.0_Unported_License licensa CC BY-SA 3.0]', # Fuzzy
...
Hãy giúp làm các trang này thú vị hơn bằng cách vui lòng đóng góp những hình ảnh của bạn mà bạn cảm thấy có thể giúp ích cộng đồng biên tập {{SITENAME}}.',
	...
	'mobile-frontend-photo-upload' => 'Thêm hình đầu tiên vào trang này', # Fuzzy
	...
	'mobile-frontend-photo-caption-placeholder' => 'Thêm lời chú hình này', # Fuzzy
	'mobile-frontend-image-loading' => 'Đang tải hình',
	'mobile-frontend-image-uploading' => 'Đang tải lên hình', # Fuzzy
	'mobile-frontend-photo-upload-error' => 'Đã xảy ra lỗi khi tải lên hình. Hãy thử hình khác.', # Fuzzy
	'mobile-frontend-photo-license' => 'Lưu ý: Tất cả các hình ảnh mà bạn xuất bản sẽ được phát hành theo [//vi.wikipedia.org/wiki/Wikipedia:Nguyên_văn_Giấy_phép_Creative_Commons_Ghi_công–Chia_sẻ_tương_tự_phiên_bản_3.0_Chưa_chuyển_đổi giấy phép CC BY-SA 3.0].', # Fuzzy
...
你捐献的图片可以使页面鲜活起来，同时也可以让{{SITENAME}}编辑社群更广泛的使用你的照片。',
	...
	'mobile-frontend-photo-upload' => '为本页添加第一张照片', # Fuzzy
	'mobile-frontend-photo-article-edit-comment' => '添加照片以用于页面',
	'mobile-frontend-photo-upload-comment' => '添加照片到页面',
	'mobile-frontend-photo-caption-placeholder' => '为本图像添加说明文字', # Fuzzy
	'mobile-frontend-image-loading' => '正在载入图像',
	'mobile-frontend-image-uploading' => '正在上传图像', # Fuzzy
	'mobile-frontend-photo-upload-error' => '上传图像时发生了错误。请尝试其它图像。', # Fuzzy
	'mobile-frontend-photo-license' => '注意：你发表的所有照片将在[//zh.wikipedia.org/wiki/Wikipedia:CC-BY-SA-3.0%E5%8D%8F%E8%AE%AE%E6%96%87%E6%9C%AC CC BY-SA 3.0协议]下释出。', # Fuzzy
);
...
$messages['zh-hant'] = array(
	...
	'mobile-frontend-donate-image-login' => '登入以查看您的上傳',
...
捐贈您的照片，使這些頁更精彩。亦讓{{SITENAME}}編輯社群使用您的照片。',
	...
	'mobile-frontend-photo-upload' => '為本頁添加第一張照片', # Fuzzy
	...
	'mobile-frontend-photo-caption-placeholder' => '添加此圖片的說明文字', # Fuzzy
	'mobile-frontend-image-loading' => '正在載入圖片',
	'mobile-frontend-image-uploading' => '正在上傳圖片', # Fuzzy
	'mobile-frontend-photo-upload-error' => '上傳圖片時發生錯誤。請嘗試其他圖片。', # Fuzzy
	'mobile-frontend-photo-license' => '注意：您發佈的所有照片將以[//en.wikipedia.org/wiki/Wikipedia:Text_of_Creative_Commons_Attribution-ShareAlike_3.0_Unported_License CC BY-SA 3.0授權]發佈', # Fuzzy
