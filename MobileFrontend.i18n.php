...
Ch'a giuta a fé vive coste pàgine donand soe figure dont a veul dësbarassesse e ch'a podrìo esse dovrà da la gròssa comunità d'editor ëd {{SITENAME}}.",
	...
	'mobile-frontend-photo-caption-placeholder' => 'Gionta na didascalìa për sta pagina', # Fuzzy
	'mobile-frontend-image-loading' => 'Carié figura',
	'mobile-frontend-image-uploading-wait' => 'Cariament figura', # Fuzzy
	'mobile-frontend-photo-upload-error' => "A l'é capitaje n'eror an cariand la figura. Për piasì preuva n'àutra figura.", # Fuzzy
	'mobile-frontend-photo-license' => "NòtA: Tute le fòto ch'it pùbliche a saran publicà sota na [//en.wikipedia.org/wiki/Wikipedia:Text_of_Creative_Commons_Attribution-ShareAlike_3.0_Unported_License licensa CC BY-SA 3.0]", # Fuzzy
