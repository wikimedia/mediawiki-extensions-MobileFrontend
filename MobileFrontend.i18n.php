...
Ayude a dar vida a estes páxines regalando les imaxes quiera dar y que puedan ser útiles pa la comunidá d'editores de {{SITENAME}}.",
	...
	'mobile-frontend-editor-refresh' => 'Refresque esta páxina pa ver los cambios.',
...
Hilf mit, Leben in diese Seiten zu bringen, indem du Bilder spendest, die von der großen {{SITENAME}}-Gemeinschaft verwendet werden können.',
	...
	'mobile-frontend-editor-refresh' => 'Aktualisiere diese Seite, um deine Änderungen zu sehen.',
...
$messages['et'] = array(
	...
	'mobile-frontend-settings-alpha' => 'Režiim [//en.wikipedia.org/wiki/Here_be_dragons Siin on lohed]', # Fuzzy
	...
	'mobile-frontend-placeholder-alpha' => 'Otsi {{GRAMMAR:elative|{{SITENAME}}}} (loherežiim)', # Fuzzy
	...
	'mobile-frontend-nearby-requirements' => 'Selle lehekülje jaoks on tarvis nii JavaScripti kui ka asukohta tundvat võrgulehitsejat.', # Fuzzy
...
Il y a beaucoup de pages qui n'ont pas de photo à cause d'un manque important de photos libres de droits. Aidez à faire vivre ces pages en donnant vos photos dont vous voulez vous débarrasser et qui pourraient être en aide à la large communauté des éditeurs de {{SITENAME}}.",
	...
	'mobile-frontend-editor-refresh' => '.حدث هذه الصفحة لترى تعديلاتك',
...
[//meta.wikimedia.org/wiki/Mobile_Projects/Mobile_Gateway#Mobile_homepage Lees widjer hü det gongt]',
	...
	'mobile-frontend-editor-refresh' => 'Aktualisiare det sidj, am din feranrangen uuntulukin.',
...
Axude a darlles vida a estas páxinas achegando aquelas imaxes que poidan ser de utilidade para a gran comunidade de editores de {{SITENAME}}.',
	...
	'mobile-frontend-editor-refresh' => 'Recargue esta páxina para ver as súas modificacións.',
...
$messages['it'] = array(
	...
	'mobile-frontend-editor-refresh' => 'Aggiorna questa pagina per vedere le modifiche.',
...
$messages['ja'] = array(
	...
	'mobile-frontend-editor-refresh' => '変更内容を表示するにはこのページを再読み込みしてください。',
...
$messages['ko'] = array(
	...
	'mobile-frontend-nearby-requirements' => '이 문서는 자바스크립트와 위치 인식 브라우저 모두 필요합니다.', # Fuzzy
	'mobile-frontend-nearby-distance' => '{{PLURAL:$1|$1 km}}',
	'mobile-frontend-nearby-distance-meters' => '{{PLURAL:$1|$1 m}}',
	'mobile-frontend-nearby-noresults' => '어딘지 모를 한가운데에 어떠한 주제도 찾을 수 없습니다. 문서를 써보지 않겠습니까?', # Fuzzy
	'mobile-frontend-nearby-refresh' => '정확한 위치를 찾았습니다. 근처 문서의 목록을 새로 고치려면 여기를 클릭하세요',
	'mobile-frontend-nearby-error' => '근처에 문서를 찾는 동안 예기치 않은 오류가 발생했습니다', # Fuzzy
...
$messages['lb'] = array(
	...
	'mobile-frontend-editor-refresh' => 'Aktualiséiert dës Säit fir Är Ännerungen ze gesinn.',
...
Помогнете ни да ги оживееме страниците - дарувајте ваши слики што би биле од полза за поширокото уредништво на {{SITENAME}}.',
	...
	'mobile-frontend-editor-refresh' => 'Превчитајте ја страницата за да ги видите промените.',
...
Tolong kami hidupkan halaman-halaman berkenaan dengan menghulurkan gambar-gambar yang sudi anda berikan dan mungkin berguna kepada seluruh komuniti penyunting {{SITENAME}}.',
	...
	'mobile-frontend-editor-refresh' => 'Muat semula halaman ini untuk melihat hasil suntingan anda.',
...
$messages['nb'] = array(
	...
	'mobile-frontend-main-menu-watchlist' => 'Overvåkingsliste',
	...
	'mobile-frontend-nearby-requirements' => 'Denne siden krever både JavaScript og en nettleser som kan finne din posisjon.', # Fuzzy
	'mobile-frontend-nearby-distance' => '{{PLURAL:$1|$1 km}}',
	'mobile-frontend-nearby-distance-meters' => '{{PLURAL:$1|$1 m}}',
	'mobile-frontend-nearby-noresults' => 'Du er utenfor allfarvei og vi kunne ikke finne noen emner. Hvorfor ikke skrive en ny artikkel?', # Fuzzy
	'mobile-frontend-nearby-refresh' => 'Vi fant en mer nøyaktig posisjon for deg. Trykk her for å oppfriske listen.',
	'mobile-frontend-nearby-error' => 'Det oppsto en uventet feil mens vi prøvde å finne sider i nærheten.', # Fuzzy
	...
	'mobile-frontend-watchlist-modified' => 'Endret for $1',
...
Help de pagina's tot leven te brengen door afbeeldingen te uploaden die u wilt weggeven en die de {{SITENAME}}gemeenschap kan gebruiken.",
	...
	'mobile-frontend-editor-refresh' => 'Ververs deze pagina om de door u gemaakte wijzigingen te bekijken.',
...
Ajutați-ne să dăm viață acestor pagini, donând acele fotografii pe care doriți să le dați mai departe și care ar putea fi în folosul editorial al comunității de la {{SITENAME}}.',
	...
	'mobile-frontend-editor-refresh' => 'Reîncărcați această pagină pentru a vă vizualiza modificările.',
...
$messages['uz'] = array(
	...
	'mobile-frontend-account-create-email-placeholder' => 'Email manzili (majburiy emas)',
	...
	'mobile-frontend-main-menu-watchlist' => "Kuzatuv ro'yxati",
...
Hãy giúp làm các trang này thú vị hơn bằng cách vui lòng đóng góp những hình ảnh của bạn mà bạn cảm thấy có thể giúp ích cộng đồng biên tập {{SITENAME}}.',
	...
	'mobile-frontend-editor-refresh' => 'Làm mới trang này để xem các thay đổi của bạn.',
...
$messages['zh-hans'] = array(
	...
	'mobile-frontend-settings-alpha-description' => '使用实验中的移动版。可以获得更多实验特性，但碰到漏洞的风险更高。',
	'mobile-frontend-save-settings' => '保存',
	'mobile-frontend-random-button' => '随机',
	'mobile-frontend-back-to-top-of-section' => '返回段落顶部',
	'mobile-frontend-close-section' => '关闭该段落',
	...
	'mobile-frontend-language-variant-header' => '选择{{#language:{{CONTENTLANG}}}}变种',
	...
	'mobile-frontend-nearby-loading' => '正在载入你当前位置附近的话题',
	'mobile-frontend-nearby-requirements' => '本页面需要JavaScript和可定位浏览器。', # Fuzzy
	...
	'mobile-frontend-nearby-noresults' => '你当前的位置附近没有任何话题。为什么不添加一个呢？', # Fuzzy
	...
	'mobile-frontend-donate-image-summary' => '图片可以使{{SITENAME}}的页面更生动。由于自由授权的图片的严重缺乏，许多页面没有图片。捐赠你同意{{SITENAME}}编辑社区使用的图片，使页面鲜活起来。',
	...
	'mobile-frontend-photo-nag-learn-more-heading' => '上传什么',
	...
	'mobile-frontend-editor-refresh' => '刷新本页以查看你的更改。',
...
$messages['zh-hant'] = array(
	...
	'mobile-frontend-nearby-lookup-ui-error-guidance' => '嘗試往空曠的地方接收更好的信號。',
...
捐贈您的照片，使這些頁更精彩。亦讓{{SITENAME}}編輯社群使用您的照片。',
	...
	'mobile-frontend-editor-refresh' => '更新此頁以查看你的更改。',
