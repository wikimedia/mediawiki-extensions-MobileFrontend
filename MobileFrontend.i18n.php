...
$messages['be-tarask'] = array(
	...
	'mobile-frontend-diffview-title' => 'Зьмена ў «$1»', # Fuzzy
...
$messages['cs'] = array(
	...
	'mobile-frontend-diffview-title' => 'Změnit na $1', # Fuzzy
...
Auta herättämään nämä sivut eloon lahjoittamalla kuviasi, joita olet valmis antamaan ja joista olisi hyötyä laajemmalle {{SITENAME}}-muokkaajayhteisölle.',
	...
	'mobile-frontend-diffview-title' => 'Ero sivuun $1', # Fuzzy
...
[//meta.wikimedia.org/wiki/Mobile_Projects/Mobile_Gateway#Mobile_homepage Lees widjer hü det gongt]',
	...
	'mobile-frontend-diffview-title' => 'Feranerangen faan $1', # Fuzzy
...
$messages['it'] = array(
	...
	'mobile-frontend-diffview-title' => 'Modifiche a $1', # Fuzzy
...
Помогите привести эти страницы в жизнь, пожертвовав изображения, которые вы готовы охотно отдать и предоставить в пользование для сообщества редакторов {{SITENAME}}.',
	...
	'mobile-frontend-diffview-title' => 'Изменения в $1', # Fuzzy
...
你捐献的图片可以使页面鲜活起来，同时也可以让{{SITENAME}}编辑社群更广泛的使用你的照片。',
	...
	'mobile-frontend-diffview-title' => '修改$1', # Fuzzy
