...
Axude a darlles vida a estas páxinas achegando aquelas imaxes que poidan ser de utilidade para a gran comunidade de editores de {{SITENAME}}.',
	...
	'mobile-frontend-photo-upload-success-generic' => 'Correcto! Grazas por contribuír.',
	'mobile-frontend-photo-license' => 'Ao premer no botón "Enviar", acepta os nosos <a href="//wikimediafoundation.org/wiki/Terms_of_Use/gl">termos de uso</a> e acepta liberar a súa fotografía baixo a <a href="//gl.wikipedia.org/wiki/Wikipedia:Texto_da_Licenza_Creative_Commons_Recoñecemento-CompartirIgual_3.0">licenza CC BY-SA 3.0</a>.',
...
[//meta.wikimedia.org/wiki/Mobile_Projects/Mobile_Gateway#Mobile_homepage Instructions on how to get this site mobile enabled]',
	...
	'mobile-frontend-donate-image-login' => 'ଆପଣଙ୍କ ଅପଲୋଡଗୁଡିକୁ ଦେଖିବା ପାଇଁ ଲଗଇନ କରନ୍ତୁ',
...
ଆପଣ ଅବଦାନ କରିବାକୁ ଚାହୁଁଥିବା ଛବିଗୁଡିକୁ ଦେଇ ଏହି ପୃଷ୍ଠାରେ ଜୀବନ ଆଣିବା ସଙ୍ଗେ ସଙ୍ଗେ {{SITENAME}} ସମ୍ପାଦନା ଗୋଷ୍ଠୀର ବ୍ୟବହାରରେ ସାହାଯ୍ୟ କରନ୍ତୁ ।',
	...
	'mobile-frontend-photo-upload-success-generic' => 'ସଫଳ ! ଆପଣଙ୍କ ଅବଦାନ ପାଇଁ ଧନ୍ୟବାଦ ।',
	'mobile-frontend-photo-license' => '"ପଇଠ"ରେ କ୍ଲିକ କରିବା ଦ୍ଵାରା ଅପଣ ଆମର <a href="//wikimediafoundation.org/wiki/Terms_of_use">ବ୍ୟବହାର କରିବା ନିୟମ</a> ସହ ରାଜି ହେଉଛନ୍ତି ଏବଂ ଆପଣଙ୍କ ଛବିଟିକୁ <a href="//en.wikipedia.org/wiki/Wikipedia:Text_of_Creative_Commons_Attribution-ShareAlike_3.0_Unported_License">କ୍ରିଏଟିଭି କମନ ଆଟ୍ରିବ୍ୟୁସନ-ସେଆରଆଲାଇକ ୩.0 ଲାଇସେନ୍ସ</a> ଅନ୍ତର୍ଗତ ରଖି ଛାଡୁଛନ୍ତି ।',
...
Помогите оживить эти страницы, пожертвовав свои изображения, которыми вы готовы поделиться для того, чтобы сообщество редакторов проекта {{SITENAME}} могло ими воспользоваться.',
	...
	'mobile-frontend-photo-upload-success-generic' => 'Загрузка удалась! Спасибо за ваш вклад.',
