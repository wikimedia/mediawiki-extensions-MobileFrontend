...
$messages['be-tarask'] = array(
	...
	'mobile-frontend-settings-alpha' => 'Рэжым «[//en.wikipedia.org/wiki/Here_be_dragons тут жывуць цмокі]»', # Fuzzy
	...
	'mobile-frontend-save-settings' => 'Захаваць налады', # Fuzzy
	...
	'mobile-frontend-placeholder-alpha' => 'Шукайце ў {{GRAMMAR:месны|{{SITENAME}}}} (рэжым з цмокамі)', # Fuzzy
	...
	'mobile-frontend-nearby-noresults' => 'Вы сігнулі ў бездань і мы не змаглі знайсьці пасуючых тэм. Чаму б не апісаць адну?', # Fuzzy
	...
	'mobile-frontend-nearby-error' => 'У часе пошуку блізкіх старонак адбылася нечаканая памылка', # Fuzzy
	'mobile-frontend-donate-image-login' => 'Увайдзіце, каб праглядзець вашыя запампоўкі.',
	'mobile-frontend-photo-upload-generic' => 'Ахвяраваць выяву', # Fuzzy
...
$messages['nn'] = array(
	...
	'mobile-frontend-nearby-noresults-guidance' => 'Freist å oppretta ein ny artikkel eller legg til staden til ein som alt finst.',
...
$messages['tr'] = array(
	...
	'mobile-frontend-save-settings' => 'Ayarları kaydet', # Fuzzy
	...
	'mobile-frontend-empty-homepage-text' => 'Bu ana sayfa yapılandırılmalıdır. <a href="http:https://www.mediawiki.org/wiki/Mobile_Gateway/Mobile_homepage_formatting">Devamını buradan okuyun</a>.', # Fuzzy
