...
$messages['is'] = array(
	...
	'mobile-frontend-donate-image' => 'Gefa mynd',
...
Помогите привести эти страницы в жизнь, пожертвовав изображения, которые вы готовы охотно отдать и предоставить в пользование для сообщества редакторов {{SITENAME}}.',
	...
	'mobile-frontend-watchlist-a-z' => 'Наблюдаемые страницы', # Fuzzy
	'mobile-frontend-watchlist-feed' => 'Страницы с изменениями', # Fuzzy
