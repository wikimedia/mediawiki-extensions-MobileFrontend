...
describe( 'Switch between views:', () => {
	...
	it( 'desktop to mobile', () => {
		...
		assert.ok( ArticlePage.switch_to_desktop_element.isDisplayed(), 'I switched from desktop to mobile.' );
		ArticlePage.switch_to_desktop_element.click();
		ArticlePage.switch_to_mobile_element.waitForExist();
		assert.ok( ArticlePage.switch_to_mobile_element.isDisplayed(), 'I switched from mobile to desktop.' );
	} );
